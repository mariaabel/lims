...
<head>        
        <!-- META SECTION -->
        <title>LIMS | Add Lab Exercise</title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="lab_exe.html">Lab Exercise</a></li>					
                    <li class="active">Add Lab Exercise</li>
                </ul>
                <!-- END BREADCRUMB -->                
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Add new Lab Exercise</h3>
                                </div>
