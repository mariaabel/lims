...
<head>        
        <!-- META SECTION -->
        <title>LIMS | Add Electronic component</title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="lab_equipments.html">Electronic components</a></li>					
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Add new Electronic component</h3>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="panel-body tab-content">
                                        <div class="tab-pane active" id="tab-first">
											...
											<div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">Model No *</label>
                                                <div class="col-md-6 col-xs-12">                                                                                                                                                        
                                                    <input type="text" class="form-control" name = "model" placeholder = "Model No *" value=""/>                                                    
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">Box number *</label>
                                                <div class="col-md-6 col-xs-12">                                                                                                                                                        
                                                    <input type="number" class="form-control" name = "box_number" placeholder = "Box number *" value=""/>                                                    
                                                </div>
                                            </div>
											<div class="form-group">
