...
<head>        
        <!-- META SECTION -->
        <title>LIMS | Electronic Components</title>            
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
									...
									<div class="btn-group pull-right">
                                        <p>
                                        <a href="add_lab_equipments.php"><button type="button" class="btn btn-info"><span class = "fa fa-plus-circle"></span> Add New Component</button></a> 
                                        </p>
                                    </div>
                                </div>
